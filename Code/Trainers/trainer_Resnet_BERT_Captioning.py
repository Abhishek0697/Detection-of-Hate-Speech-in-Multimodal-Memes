...
def train(image_model,text_model,fusion_model,data_loader,test_loader,criterion,optimizer, lr_scheduler, modelpath, writer, device, epochs):
    ...
    for epoch in range(epochs):
        ...
        for batch_num, (feats, captions, input_ids, attention_masks, input_ids_cap, attention_masks_cap, target) in enumerate(data_loader):
...
def test_classify(image_model, text_model, fusion_model, test_loader, criterion, device):
    ...
    for batch_num, (feats, captions, input_ids, attention_masks, input_ids_cap, attention_masks_cap, target) in enumerate(test_loader):
